  ...
  >
    <ul class="flex flex-col w-full h-full justify-center space-y-6">
      <li @click="this.handleUser" class="flex flex-row items-center">
        ...
        <span class="cursor-pointer text-xl ml-5 text-white">Home</span>
      </li>
      <li @click="this.handleWorkingTime" class="flex flex-row items-center">
        <i class="fa-solid fa-clock text-white text-3xl"></i>
        <span
          class="cursor-pointer text-xl ml-5 w-24 text-white whitespace-nowrap"
          >Clock it</span
        >
      </li>
      ...
      <li @click="this.handleCalendar" class="flex flex-row items-center">
        <i class="fa-solid fa-calendar text-white text-3xl cursor-pointer"></i>
        <span
          class="text-xl ml-5 w-24 text-white whitespace-nowra cursor-pointer"
        >
          Calendar
        </span>
      </li>
